    ...
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-12 ">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/3 text-sm text-gray-600">
          <p>
            Welcome to SAMARTH HOSPITAL, your trusted partner in managing your
            healthcare needs conveniently and efficiently. At SAMARTH HOSPITAL,
            we understand the challenges individuals face when it comes to
            scheduling doctor appointments and managing their health records.
          </p>

          <p>
            SAMARTH HOSPITAL is committed to excellence in healthcare
            ...
            appointment or managing ongoing care, SAMARTH HOSPITAL is here to
            support you every step of the way.
          </p>

          <b className="text-gray-800">Our Vision</b>
          <p>
            Our vision at SAMARTH HOSPITAL is to create a seamless healthcare
      ...
      <div className="flex flex-col md:flex-row mb-20 ">
        <div
          className="border px-8 md:px-10 py-6 sm:py-10 flex flex-col gap-4 text-[15px]
